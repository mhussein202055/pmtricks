...
Route::get('delet/comment/review/{id}', function($id){
...
Route::prefix('admin')->group(function(){
    ...
    */
     ...
     * Statistics
     */
    Route::get('/statics/course/{id}/year/{year}/month/{month}/packae/{package}', 'AdminController@statics_index')->middleware('auth:admin')->name('statics.index');
...
Route::get('/my_packages/{type}/cat/{cat}', 'Users\PremiumQuizController@myPackages_view')->middleware('auth')->name('my.package.view');
...
Route::post('/payment/price/details', 'PaymentController@price_details')->name('price.details');
