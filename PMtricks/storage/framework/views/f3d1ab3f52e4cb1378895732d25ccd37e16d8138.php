<?php $__env->startSection('content'); ?>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                                ...
                                <div class="portlet-body">
                                    <div class="panel panel-default">
                                                <div class="panel-heading">
                                                     <?php $__currentLoopData = \App\FlashCard::orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <h4 class="panel-title" style="color: blue">
                                                      
                                                        <a class="accordion-toggle"  href="<?php echo e(route('flashCard.show', $f->id)); ?>" style="font-size: 20px"><?php echo e($f->title); ?>  </a>
                                                    </h4>
             ...
             <!--                                       <td> <a href="<?php echo e(route('flashCard.show', $f->id)); ?>" class="btn red" > Read-->
