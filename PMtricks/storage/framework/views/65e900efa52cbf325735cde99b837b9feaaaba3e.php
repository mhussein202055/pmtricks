...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>PM-TRICKS | Register </title>
        ...
        <link href="<?php echo e(asset('assets/pages/css/login-2.min.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="register_form" action="<?php echo e(route('register')); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?> " value="<?php echo e(old('name')); ?>" type="text" placeholder="Full Name" name="name" /> </div>
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9 <?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>">Email</label>
                ...
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9 <?php echo e($errors->has('country') ? ' is-invalid' : ''); ?>">Country</label>
                ...
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9 <?php echo e($errors->has('city') ? ' is-invalid' : ''); ?>">City</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="City" name="city" value="<?php echo e(old('city')); ?>" /> </div>

                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9 <?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>">Phone Number</label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Phone Number" name="phone" value="<?php echo e(old('phone')); ?>" /> </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" type="password" autocomplete="off" id="register_password" placeholder="Password" name="password" /> </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>By clicking Submit, you agree to our <a data-toggle="modal" data-target="#myModal" >Terms, Policy</a></label>
                </div>
              ...
              <!--  <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>
                        ...
                        The https://sswls.com  website policy and ground rules: <br/>

1) All rights are reserved. The ownership of this website content belongs only to https://sswls.com.  <br/>

2) Copying or sharing any content of this website is not allowed and is a legal violation.  <br/>

3) It is not allowed for users to use any of the website contents for classrooms, training,  or preparing posts, lectures, or exams. This results in legal violations.  <br/>

4) Sharing one user account by more than one person is not accepted and may result in the user account cancellation <br/>

5) The user has the  right to have online access to the exams in the website and the objective is only to help him understand in depth to pass the PMP exam. <br/>
