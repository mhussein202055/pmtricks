                ...
                <div class="portlet light form-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green sbold uppercase">Course: <?php echo e(\App\Course::find($course_id)->title); ?></span>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select v-model="chapter_id" class="form-control">
                                        <?php $__currentLoopData = \App\Chapters::where('course_id', $course_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('jscode'); ?>
        ...
        <script>
            var app = new Vue({
                ...
                data: {
                    course_id: '<?php echo e($course_id); ?>',
                    chapter_id: '',
                    current_videos_list: [],
                ...
                methods: {
                    ...
                    select: function(video){
                        if(this.selected_video_index != 0 && this.selected_video_index != video.index_z){
                            ...
                            $.ajax ({
                                type: 'POST',
                                url: '<?php echo e(route('videoReplace')); ?>', 
                                data: Data,
                    ...
                    getChapterVideos: function(){
                        if(this.chapter_id != ''){
                            ...
                            $.ajax ({
                                type: 'POST',
                                url: '<?php echo e(route('getChapterVideos')); ?>', 
                                data: Data,
                                success: function(res){
                                    console.log(res);
                                    // reset
