                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-white-sharp" style="color:#ffffff">
                                            <span data-counter="counterup" data-value="<?php echo e($p_num); ?>">0</span>
                                ...
                                <div class="display" style="color:#ffffff">
                                    <div class="number">
                                        <h3 class="font-red-haze" style="color:#ffffff">
                                            <span data-counter="counterup" data-value="<?php echo e($q_num); ?>" style="color:#ffffff">0</span>
                                        </h3>
                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp" style="color:#ffffff">
                                            <span data-counter="counterup" data-value="<?php echo e($o_num); ?>" style="color:#ffffff"></span>
                                        </h3>
                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-purple-soft" style="color:#ffffff">
                                            <span data-counter="counterup" data-value="<?php echo e($u_num); ?>" style="color:#ffffff"></span>
                                        </h3>
