...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <p>
            Notice That: All quizzes result are kept for you to reivew you progress.
        </p>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Score History </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if(count($score)> 0): ?>
                                <?php $__currentLoopData = $score; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td></td>
                                        <td><?php echo e($s->package); ?></td>
                                        <td><?php echo e($s->topic); ?></td>
                                        <td><?php echo e($s->question_number); ?></td>
