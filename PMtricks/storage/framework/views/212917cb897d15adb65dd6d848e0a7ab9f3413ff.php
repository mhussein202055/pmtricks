                                                ...
                                                <?php if(count($packages) > 0): ?>
                                                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($package->extension_price); ?> $</td>
                                                            <td><?php echo e($package->expire_in_days); ?> day(s)</td>
                                                            <td><?php echo e($package->extension_in_days); ?> day(s)</td>

                                                            <td><a href="<?php echo e(route('packages.edit', $package->id)); ?>">Edit</a></td>
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="DeleteModal-<?php echo e($package->id); ?>" role="dialog">
                                                                    <div class="modal-dialog">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <?php echo Form::open(['action'=>['packageController@destroy', $package->id], 'method'=>'POST']); ?>
