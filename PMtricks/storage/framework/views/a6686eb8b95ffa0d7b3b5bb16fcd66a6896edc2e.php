        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo e(route('login')); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?> form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>" required autofocus /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" type="password" autocomplete="off" placeholder="Password" name="password" required/> </div>
                ...
                <div class="create-account">
                    <p>
                        <a href="<?php echo e(route('register')); ?>" id="register-btn" class="uppercase">Create an account</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
