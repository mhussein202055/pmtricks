              ...
              <div class="modal-dialog">
                <div class="modal-content"> 
                  ...
                  <div class="modal-header backgroud-style">
                    ...
                    <div class="popup-logo"> <img src="indexassets/img/logo/p-logo.png" alt=""  style="width: 72 px;height: 68px"> </div>
										...
										<div class="modal-content">
											...
											<div class="modal-header backgroud-style">
												...
												<div class="popup-logo">
													<img src="<?php echo e(asset('indexassets/img/logo/p-logo.png')); ?>" alt="" style="width: 72 px;height: 68px">
												</div>
												<div class="popup-text text-center">
  ...
  <div class="container">
    <div class="page-breadcrumb-content text-center">
      <div class="page-breadcrumb-title">
        <h2 class="breadcrumb-head black bold"> <span>Welcom Back,</span></h2>
      </div>
...
<!-- Start of course section
		============================================= -->
<section id="popular-course" class="popular-course-section" style="padding: 50px 250px 0px;">
	    <div class="container">
	        <div class="section-title mb20 headline text-left "  >
				
				<h2><span class="subtitle text-uppercase" style="font-weight:700; font-size:40px; color:#000000;">my courses</span> </h2>
				</div>
		 <!--<div class="row">-->
   <!--       <div class="col-md-12">-->
   <!--           <h1>My courses</h1>-->
...
<section id="course-page" class="course-page-section" style=" padding: 20px 0px 0px;">
  <div class="container">

    <div class="row" id = "app-2">
      <div class="col-md-12">
        <div class="short-filter-tab">
          <div class="shorting-filter  float-left"> <span><b>View</b> By</span>
            <select v-model="type" v-on:change="update_page">
              <option value="all" <?php if($type == 'all'): ?> selected <?php endif; ?>>All</option>
              <option value="exam" <?php if($type == 'exam'): ?> selected <?php endif; ?>>Mock Exams</option>
          ...
          <div class="shorting-filter float-right"> <span><b>Categories</b> By</span>
            <select v-model="cat" v-on:change="update_page">
              <option value="all" <?php if($cat == 'all'): ?> selected <?php endif; ?> >All Categories</option>
              <?php $__currentLoopData = \App\Course::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($i->id); ?>" <?php if($cat == $i->id): ?> selected <?php endif; ?> ><?php echo e($i->title); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
        </div>
            ...
            <div id="tab1" class="tab-content-1 pt35">
              <div class="best-course-area best-course-v2">
                <div class="row">
                  ...
                  <?php $__currentLoopData = $exam_package_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="col-md-3">
                    <div class="course-item-pic-text " >
                      <div class="course-pic relative-position mb25"> 
                        <a href="<?php echo e(route('attach.package', $i->id)); ?>">
                          <img src="<?php echo e(url('storage/package/imgs/'.basename($i->img))); ?>" alt=""> 
                        </a>
                      </div>
                      <div class="course-item-text">
                        <div class="course-title mt10 headline pb45 relative-position">
                          <h3><a href="<?php echo e(route('attach.package', $i->id)); ?>"><?php echo e($i->name); ?> [Exam]</a></h3>
                        </div>
                        <div class="course-meta"> <span class="course-category bold-font"><a href="#"><?php echo e(\App\Course::find($i->course_id)->title); ?></a></span>
                          <div class="course-rate ul-li">
                            <?php
                            $total_rating = 0;
                            $rate = \App\Rating::where('package_id', $i->id)->get();
                            foreach($rate as $r){
                              $total_rating += $r->rate;
                            }
                            if($rate->first()){
                                $total_rating = $total_rating / count($rate);
                            }else{
                                $total_rating = 0;
                            }
                            ...
                            ?>
                            <ul>
                              <li><i class="fas fa-star" style="<?php if($total_rating >= 1): ?> color: orange; <?php endif; ?>"></i></li>
                              <li><i class="fas fa-star" style="<?php if($total_rating >= 2): ?> color: orange; <?php endif; ?>"></i></li>
                              <li><i class="fas fa-star" style="<?php if($total_rating >= 3): ?> color: orange; <?php endif; ?>"></i></li>
                              <li><i class="fas fa-star" style="<?php if($total_rating >= 4): ?> color: orange; <?php endif; ?>"></i></li>
                              <li><i class="fas fa-star" style="<?php if($total_rating >= 5): ?> color: orange; <?php endif; ?>"></i></li>
                            </ul>
                          </div>
                        </div>
                        
                        <a href="<?php echo e(route('attach.package', $i->id)); ?>">Get Started <i class="fas fa-caret-right"></i></a> 
                        
                      </div>
                    </div>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php $__currentLoopData = $video_package_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="col-md-3">
                    <div class="course-item-pic-text " >
                      <div class="course-pic relative-position mb25"> 
                        <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                            <?php
                                $last_video_progress = \App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id;
                                $video = \App\Video::find($last_video_progress);
                                if($video){
                                    $last_video_chapter_id = $video->chapter;
                                    $video_id_ = \App\Video::where('chapter',explode(',',\App\Packages::find($i->id)->chapter_included)[0])->get()->first()->id;
                                }else{
                                    $last_video_chapter_id = explode(',',\App\Packages::find($i->id)->chapter_included)[0];
                                    $video_id_ = \App\Video::where('chapter',explode(',',\App\Packages::find($i->id)->chapter_included)[0])->get()->first()->id;
                                }

                            ?>
                              <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', $last_video_chapter_id , $video_id_])); ?>" class="btn blue">
                                  <img src="<?php echo e(url('storage/package/imgs/'.basename($i->img))); ?>" alt="">
                              </a>

                        <?php else: ?>
                              <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', explode(',',\App\Packages::find($i->id)->chapter_included)[0] , \App\Video::where('chapter',explode(',',\App\Packages::find($i->id)->chapter_included)[0])->get()->first()->id])); ?>" class="btn blue">
                                  <img src="<?php echo e(url('storage/package/imgs/'.basename($i->img))); ?>" alt="">
                              </a>
                        <?php endif; ?>
                      ...
                      <div class="course-item-text">
                        <div class="course-title mt10 headline pb45 relative-position">
                            ...
                            <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                                    ...
                                    <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', $last_video_chapter_id , $video_id_])); ?>" >
                                        <?php echo e($i->name); ?> [Video]
                                    </a>
                                <?php else: ?>

                                    <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', explode(',',\App\Packages::find($i->id)->chapter_included)[0] , \App\Video::where('chapter',explode(',',\App\Packages::find($i->id)->chapter_included)[0])->get()->first()->id])); ?>" >
                                        <?php echo e($i->name); ?> [Video]
                                    </a>
                                <?php endif; ?>
                        ...
                        <div class="progress">
                          ...
                          $chapters_inc = [];
                          $total_videos_no = 0;
                          $completed_videos_no = count(\App\VideoProgress::where('package_id', $i->id)->where('user_id', Auth::user()->id)->where('complete', 1)->get());
                          // calculate the chapters included within the package 
                          if($i->chapter_included != '' || $i->chapter_included != null){
                              $arr_chapters_id = explode(',',$i->chapter_included);
                          ...
                          ?>
                          <div class="progress-bar" role="progressbar" style="width: <?php echo e($percentage); ?>%" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                              ...
                              ?>
                            <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', $last_video_chapter_id, $video_id_])); ?>" class="btn blue"> Continue learning <i class="fas fa-caret-right"></i></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', explode(',',\App\Packages::find($i->id)->chapter_included)[0] , \App\Video::where('chapter',explode(',',\App\Packages::find($i->id)->chapter_included)[0])->get()->first()->id])); ?>" class="btn blue">Start Course <i class="fas fa-caret-right"></i></a>
                        <?php endif; ?>
                  ...
                  <tr>
                    <td>
                      <div class="course-list-img-text">
                        <div class="course-list-img"> <img src="<?php echo e(url('storage/package/imgs/'.basename($i->img_small))); ?>" alt=""> </div>
                        <div class="course-list-text">
                          <h3><a href="#"><?php echo e($i->name); ?> [Exam]</a></h3>
                          <div class="course-meta"> <span class="course-category bold-font"><a href="#"><?php echo e(\App\Course::find($i->course_id)->title); ?></a></span>
                            <div class="course-rate ul-li">
                              <?php
                              $total_rating = 0;
                    ...
                    <td><a href="<?php echo e(route('attach.package', $i->id)); ?>"><div class="course-type-list"> <span>Go To Courses</span> </div></a></td>
                    <td><?php echo e(\App\UserPackages::where('user_id',Auth::user()->id)->where('package_id', $i->id)->get()->first()->created_at); ?></td>
                    <td><?php echo e($i->expire_in_days); ?> days</td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tr>
                    <td>
                      <div class="course-list-img-text">
                        <div class="course-list-img"> <img src="<?php echo e(url('storage/package/imgs/'.basename($i->img_small))); ?>" alt=""> </div>
                        <div class="course-list-text">
                          <h3><a><?php echo e($i->name); ?> [Videos]</a></h3>
                          <div class="course-meta"> <span class="course-category bold-font"><a href="#"><?php echo e(\App\Course::find($i->course_id)->title); ?> </a></span>
                            <div class="course-rate ul-li">
                              <?php
                              $total_rating = 0;
                    ...
                    <td>
                      <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                            ...
                            ?>
                          <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', $last_video_chapter_id, $video_id_])); ?>" class="btn blue">
                            <div class="course-type-list"> <span>Continue</span></div>
                          </a>
                      <?php else: ?>
                          <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', explode(',',\App\Packages::find($i->id)->chapter_included)[0] , \App\Video::where('chapter',explode(',',\App\Packages::find($i->id)->chapter_included)[0])->get()->first()->id])); ?>" class="btn blue">
                          <div class="course-type-list"> <span>Start Course</span></div>
                          </a>
                      <?php endif; ?>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="copy-right-text">
              <p>© 2019 - PM-Tricks.com. All rights reserved</p>
            </div>
          </div>
          <div class="col-md-6">
        ...
        var app2 = new Vue({
            ...
            methods: {
              update_page: function(){
                window.location.replace('<?php echo e(url('')); ?>/my_packages/'+this.type+'/cat/'+this.cat);
              }
            }
