        ...
        var app = new Vue({
            ...
            data: {
                ...
                PGroup_data: [
                    ...
                    <?php if(count($all[1]) > 0): ?>
                        <?php $__currentLoopData = $all[1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($pg->name); ?>',
                ...
                Karea_data: [
                    ...
                    <?php if(count($all[0]) > 0): ?>
                        <?php $__currentLoopData = $all[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ka): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($ka->name); ?>',
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                ...
                course_new: '',
                courses_data: [
                    <?php if(count($all[3]) > 0): ?>
                        <?php $__currentLoopData = $all[3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($cr->title); ?>',
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                ],
                projectMGroup_new: '',
                projectMGroup_data: [
                    <?php if(count($all[2]) > 0): ?>
                        <?php $__currentLoopData = $all[2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pmg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($pmg->name); ?>',
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                ],
            ...
            methods: {
                addNewCourse: function(e){
                    if( this.course_new == ''){
                        ...
                        $.ajax ({
                           type: 'POST',
                           url: '<?php echo e(route('chapterManager.add')); ?>', 
                           data: Data,
                ...
                DeleteCourse: function(item){
                    ...
                    $.ajax ({
                        type: 'DELETE',
                        url: '<?php echo e(route('chapterManager.delete')); ?>', 
                        data: Data,
                        success: function(res){
                            // do nothing
                            console.log(res);
