                    ...
                    <div class="course-item-pic-text " >
                      <div class="course-pic relative-position mb25"> 
                        <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                            <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', \App\Video::find(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id)->chapter , \App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id])); ?>" class="btn blue">
                              <img src="<?php echo e(url('storage/package/imgs/'.basename($i->img))); ?>" alt="">
                            </a>
                        <?php else: ?>
                      ...
                      <div class="course-item-text">
                        <div class="course-title mt10 headline pb45 relative-position">
                            <h3>
                                ...
                                <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                                  <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', \App\Video::find(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id)->chapter , \App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id])); ?>" > 
                                    <?php echo e($i->name); ?> [Videos]
                                  </a>
                                <?php else: ?>
                        ...
                        <?php if(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->get()->first()): ?>
                            <a href="<?php echo e(route('st4_vid', [$i->id, 'chapter', \App\Video::find(\App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id)->chapter , \App\VideoProgress::where('user_id', Auth::user()->id)->where('package_id',$i->id)->where('complete', 1)->orderBy('updated_at', 'desc')->get()->first()->video_id])); ?>" class="btn blue"> Continue learning <i class="fas fa-caret-right"></i></a>
                        <?php else: ?>
