                    ...
                    <div class="col-md-6">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                ...
                                <form action="<?php echo e(route('user.feedback.store')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-6">
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                ...
                                <?php $__currentLoopData = \App\Feedback::where('user_id', Auth::user()->id)->where('disable', 0)->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row" style="margin: 10px 0;">
                                    <div class="col-md-12" style="background-color:antiquewhite; padding: 12px; border-radius: 10px !important;">
                                        <p style="font-weight: bold; width:100%;">
                                            <?php echo e($feed->created_at->diffForHumans()); ?>

                                            <a href="<?php echo e(route('user.feedback.delete', $feed->id)); ?>" style="float: right; margin: 0 5px 0 0;">Delete</a>
                                        </p>
