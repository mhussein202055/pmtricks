                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form vueform">
                                    <?php echo Form::open(['action' => ['QuestionsController@update', $question->id], 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal']); ?>

                                        <div class="form-body">
                                            <div class="form-group form-md-line-input has-success">
                                                <label class="col-md-2 control-label" for="form_control_1">Question</label>
                                                <div class="col-md-10">
                                                    <?php echo e(Form::textarea('question', $question->title, ['class' => 'form-control', 'placeholder'=>'Question', 'row'=>'3','style'=>'margin: 0px 0.65625px 0px 0px; height: 200px; width: 1312px;'])); ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <?php echo e(Form::text('correct_answer', $question->correct_answer, ['class' => 'form-control', 'placeholder'=>'Correct Answer', 'id'=>'form_control_1'])); ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <?php echo e(Form::text('answer_a', $question->a, ['class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])); ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <?php echo e(Form::text('answer_b', $question->b, ['class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])); ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <?php echo e(Form::text('answer_c', $question->c, ['class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])); ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <select v-model="chapter" class="form-control chapter" id="form_control_1" v-on:change="searchChapter"  v-model="chapter" name="chapter">
                                             ...
                                             <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select v-model="pmg" class="form-control" id="pmg" v-on:change="searchPMG"  v-model="pmg" name="pmg" <?php if($pmg_value == ''): ?> disabled <?php endif; ?>>
                                                            <option disabled value="">Choose one </option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <?php if($question->img != Null): ?>
                                                            Old Image: 
                                                            <img width="200" src="<?php echo e(asset('storage/questions/'.basename($question->img))); ?>">
                                                        <?php endif; ?>
                                                        <div>
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                ...
                                                <div class="col-md-10">
                                                        <?php echo e(Form::textarea('feedback',$question->feedback,['class'=>'form-control','row'=>'3','placeholder'=>'Feedback for the Correct Answer', 'style'=>'margin: 0px 0.65625px 0px 0px; height: 200px; width: 1312px;'])); ?>
            ...
            var app = new Vue({
                ...
                data:{
                    exam_number:
                        '<?php echo e($exams); ?>'
                    ,
                    demo:<?php echo e($question->demo); ?>,
                    chapter:'<?php echo e(\App\Chapters::find($question->chapter)->name); ?>',
                    chapter_data: [
                        <?php $__currentLoopData = \App\Chapters::where('course_id', '=', $course)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            '<?php echo e($ch->name); ?>',
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ],
                    pmg: '<?php echo e($pmg_value); ?>',
                    pmg_data: [
                        <?php if(count($pmg_list)> 0): ?>
                            <?php $__currentLoopData = $pmg_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pmg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                '<?php echo e($pmg); ?>',
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>

                    ],
                    process_group: '<?php echo e($pgroup_value); ?>',
                    process_group_data: ['<?php echo e($pgroup_value); ?>'],
                    course: '<?php echo e($course); ?>',
                },
                methods:{
