                ...
                <div class="portlet light form-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green sbold uppercase">FAQ s</span>
                        </div>
                    ...
                    <div class="portlet-body form">
                        ...
                        <form class="form-horizontal form-bordered" method="POST" action="<?php echo e(route('faq.add')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-body">
                                <div class="form-group last">
                                    <label class="control-label col-md-2">Title </label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control"  name="title" id="maxlength_thresholdconfig">
                                    </div>
                                </div>
                                <div class="form-group last">
                                    <label class="control-label col-md-2">FAQ </label>
                                    <div class="col-md-10">
                                        <textarea name="contant" class="jqte-test"></textarea>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light form-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-settings font-green"></i>
                            <span class="caption-subject font-green sbold uppercase">Show All</span>
                        </div>
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('faq.edit', $q->id)); ?>">Edit</a>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('faq.delete', $q->id)); ?>">Delete</a>
                                    </td>
                                </tr>
