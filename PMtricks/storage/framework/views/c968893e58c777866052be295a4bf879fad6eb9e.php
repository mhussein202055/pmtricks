                            ...
                            <div class="container" id="app1" style="display:flex; justify-content: center; align-items:center;  padding:20px 0;">
                                ...
                                <div class="card col-lg-10 col-md-10 col-sm-12 col-xm-12" style="padding:0">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <?php echo Form::open(['action' => 'packageController@store', 'method'=>'POST', 'enctype'=>'multipart/form-data']); ?>

                                            <div class="form-group">
                                                <strong><?php echo e(Form::label('name','Package Name :')); ?></strong>
                                                <?php echo e(Form::text('name', '', ['class' => 'form-control', 'placeholder'=>'Package name'])); ?>

                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <strong><?php echo e(Form::label('price','Original Price :')); ?></strong>
                                                        <?php echo e(Form::text('price', '', ['class' => 'form-control', 'placeholder'=>'Price before the discount'])); ?>

                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <strong><?php echo e(Form::label('discount','Discount (%) :')); ?></strong>
                                                        <?php echo e(Form::text('discount', '', ['class' => 'form-control', 'placeholder'=>'discount percentage'])); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3"> 
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('extension_price', '', ['class' => 'form-control', 'placeholder'=>'extension price'])); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('lang', '', ['class' => 'form-control', 'placeholder'=>'Course language'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('certification_title', '', ['class' => 'form-control', 'placeholder'=>'Certification Title'])); ?>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <ul class="list-group">
                                                        <?php $__currentLoopData = $chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li class="list-group-item">
                                                                <?php echo e(Form::checkbox('c'.$ch->id, $ch->name,'', ['id'=>'c'.$ch->id])); ?>

                                                                <label for="c<?php echo e($ch->id); ?>"><?php echo e($ch->name); ?></label>
                                                            </li>
                                                ...
                                                <div class="form-group process_view" style="display:none;">
                                                    ...
                                                    <ul class="list-group">
                                                        <?php $__currentLoopData = $process; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="list-group-item">
                                                                <?php echo e(Form::checkbox('p'.$pg->id, $pg->name,'',['id'=>'p'.$pg->id])); ?>

                                                                <label for="p<?php echo e($pg->id); ?>"><?php echo e($pg->name); ?></label>
                                                            </li>
                                            ...
                                            <div class="form-group">
                                                <?php echo e(Form::submit('Create', ['class'=>'btn green float-right'])); ?>
