...
-->
                ...
                <div id="tab2" class="tab-content-1 pt35" style="padding:0 !important;">
                  <div id="accordion-2" class="panel-group">
                    ...
                    <?php $__currentLoopData = \App\FAQ::orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class=" col-15" >
                      <div class="panel-title " id="heading11">
                        <h3 class="mb-0">
                          <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse<?php echo e($f->id); ?>" aria-expanded="true" aria-controls="collapse11" ><?php echo e($f->title); ?> </button>
                        </h3>
                      </div>
                      <div id="collapse<?php echo e($f->id); ?>" class="collapse" aria-labelledby="heading11" data-parent="#accordion-2">
                        <div class="panel-body"> <?php echo $f->contant; ?> </div>
                      </div>
                    </div>
                    <hr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
