                ...
                <div class="portlet light form-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green sbold uppercase">Promotions</span>
                        </div>
                    ...
                    <div class="portlet-body form">
                        ...
                        <form class="form-horizontal form-bordered" method="POST" action="<?php echo e(route('promotion.send')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-body">
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-10">
                                        <select name="package_id" id="package" class="form-control">
                                            <?php $__currentLoopData = \App\Packages::orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-body">
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="msg" class="jqte-test"></textarea>
                                    </div>
                                </div>
                            </div>
