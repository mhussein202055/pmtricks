                                ...
                                <div class="portlet-body">
                                    <div class="table-scrollable">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = \App\Video::where('demo','=', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td></td>
                                                    <td> <?php echo e($v->title); ?> </td>
                                                    <td > <?php echo e(\App\Chapters::find($v->chapter)->name); ?> </td>
                                                    <td><a href="<?php echo e(route('video.show.free', $v->id)); ?>" class="btn green">   <i class="fa fa-play-circle"></i></a></td>
                                                </tr>
