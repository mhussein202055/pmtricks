          ...
          <div class="side-bar">
            ...
            <div class="couse-feature ul-li-block">
              <ul>
                  ...
                  <li>Practice tests <span><?php echo e(count($chapter_list) + count($process_list) + count($exam_list)); ?> </span></li>
                  <?php endif; ?>
            ...
            <div class="course-details-category ul-li"> <span>Course <b>content :</b></span>
              <ul style="text-align:right; padding-right:90px">
                ...
                <li>
                    ...
                    <?php echo e($total_question_num); ?> Questions
                    ...
                    <div class="panel-title" id="headingOne">
                        <div class="ac-head">
                            ...
                            <div class="leanth-course"> 
                                ...
                                <span><?php echo e($chapter_data->question_num); ?> Questions</span>
                    ...
                    <div class="panel-title" id="heading2">
                        <div class="ac-head">
                            ...
                            <div class="leanth-course">
                              ...
                              <span><?php echo e($process_data->question_num); ?> Questions</span>
                    ...
                    <div class="panel-title" id="headingtwo">
                        ...
                        <div class="ac-head">
                            ...
                            <div class="leanth-course">
                              ...
                              <span><?php echo e($exam_data->question_num); ?> Questions</span>
                            </div>
                        </div>
                    </div>
          ...
          <div class="blog-comment-area ul-li about-teacher-2">
            <ul class="comment-list">
                ...
                <li style="width:100%">
                    ...
                    ?>
                  <div class=" comment-avater"> <img style="overflow:none; width:68; height: 68px;" src="<?php echo e($pic); ?>" alt=""> </div>
