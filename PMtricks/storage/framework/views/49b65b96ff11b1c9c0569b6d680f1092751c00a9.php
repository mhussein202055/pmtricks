                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">PMP Materials</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="table-scrollable">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php if(\App\Material::where('course_id', '=', $course_id)->get()->first()): ?>
                                                    <?php $__currentLoopData = \App\Material::where('course_id', '=', $course_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td> </td>
                                                            <td><?php echo e($m->title); ?></td>
                                                            <td > <a href=" <?php echo e(route('download.material', $m->id)); ?>" class="btn green">   <i class="fa fa-download"></i></a>  </td>
