        ...
        <div style="background: white; padding: 30px 15px; height: auto;">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if(count(\App\PaymentExtensionApprove::all()) ): ?> 
                            <?php $__currentLoopData = \App\PaymentExtensionApprove::orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approve): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\App\User::find($approve->user_id)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('extension.payment.approve', $approve->id)); ?>">Approve</a>   |   
                                        <a style="color:brown;" href="<?php echo e(route('extension.payment.cancel', $approve->id)); ?>">Cancel</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
