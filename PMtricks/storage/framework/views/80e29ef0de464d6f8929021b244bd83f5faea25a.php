                ...
                <div class="profile-sidebar">
                    ...
                    <div class="portlet light profile-sidebar-portlet ">
                        ...
                        <?php if($user_details): ?>
                            <?php if($user_details->profile_pic): ?>
                                <div class="profile-userpic col-md-2" >
                                    <img src="<?php echo e(url('storage/profile_picture/'.basename($user_details->profile_pic))); ?>" class="img-responsive" alt=""> 
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        <!-- END SIDEBAR USERPIC -->
                        ...
                        <div class="profile-usertitle">
                            ...
                            <div class="profile-usertitle-job"> <?php echo e(($user_details)? $user_details->occupation: ''); ?>   </div>
                        </div>
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="row list-separated profile-stat">
                            ...
                            <div class="col-xs-6">
                                <div class="uppercase profile-stat-title"> <?php echo e(count( \App\UserScore::where('user_id', '=', Auth::user()->id)->where('score','>=', '50')->get() )); ?> </div>
                        ...
                        <!-- END STAT -->
                        <div>
                            <h4 class="profile-desc-title">About <?php echo e(Auth::user()->name); ?></h4>
                            <span class="profile-desc-text"><?php echo e(($user_details)? $user_details->about: ''); ?> </span>
                            <?php if($user_details): ?>
                                <?php if($user_details->website_url): ?>
                                    <div class="margin-top-20 profile-desc-link">
                                        <i class="fa fa-globe"></i>
                                        <a target="_blank" href="<?php echo e($user_details->website_url); ?>"><?php echo e($user_details->website_url); ?></a>
                                    </div>
                                <?php endif; ?>

                                <?php if($user_details->tw_url): ?>
                                    <div class="margin-top-20 profile-desc-link">
                                        <i class="fa fa-twitter"></i>
                                        <a target="_blank" href="<?php echo e($user_details->tw_url); ?>">Twitter</a>
                                    </div>
                                <?php endif; ?>

                                <?php if($user_details->fb_url): ?>
                                    <div class="margin-top-20 profile-desc-link">
                                        <i class="fa fa-facebook"></i>
                                        <a target="_blank" href="<?php echo e($user_details->fb_url); ?>">Facebook</a>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <form role="form" action="<?php echo e(route('user.update.profile')); ?>" method="post" >
                                                <?php echo csrf_field(); ?>
                                                <div class="form-group">
                                                    <label class="control-label">Full Name </label>
                                                    <span class="required"> * </span>
                                                    <input type="text" value="<?php echo e(Auth::user()->name); ?>" class="form-control" name="name" /> </div>
                                                <div class="form-group">
                                                    <label class="control-label">Email </label>
                                                    <span class="required"> * </span>
                                                    <input type="text" value="<?php echo e(Auth::user()->email); ?> " name="email" class="form-control" /> </div>
                                                <div class="form-group">
                                                    <label class="control-label">Mobaile Numbrer </label>
                                                    <span class="required"> * </span>
                                                    <input type="text" value="<?php echo e(Auth::user()->phone); ?>" name="phone" class="form-control" /> </div>
                                                <div class="form-group">
                                                    <label class="control-label">City/Town</label>
                                                    <span class="required"> * </span>
                                                    <input type="text" class="form-control" value="<?php echo e(Auth::user()->city); ?>" name="city" /></div>
                                                <div class="form-group">
                                                    <label class="control-label">Country: <?php echo e(Auth::user()->country); ?></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Interests" class="form-control" value="<?php echo e(($user_details)? $user_details->interests: ''); ?>" name="interests" /> </div>
                                                <div class="form-group">
                                                    <label class="control-label">Occupation</label><span class="required"> * </span>
                                                    <input type="text" placeholder="occupation" class="form-control" value="<?php echo e(($user_details)? $user_details->occupation: ''); ?>" name="occupation" /> </div>
                                                <div class="form-group">
                                                    <label class="control-label">About</label>
                                                    <textarea class="form-control" rows="3" placeholder="" name="about"><?php echo e(($user_details)? $user_details->about: ''); ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Website Url</label>
                                                    <input type="text" placeholder="http://www.mywebsite.com" class="form-control" value="<?php echo e(($user_details)? $user_details->website_url : ''); ?>" name="website_url" /> </div>
                                                    <div class="form-group">
                                                    <label class="control-label">Facebook Url</label>
                                                    <input type="text" placeholder="facebook" class="form-control" value="<?php echo e(($user_details)? $user_details->fb_url : ''); ?>" name="fb_url" /> </div>
                                                    <div class="form-group">
                                                    <label class="control-label">Twitter Url</label>
                                                    <input type="text" placeholder="Twitter" class="form-control" value="<?php echo e(($user_details)? $user_details->tw_url : ''); ?>" name="tw_url" /> </div>
                                        ...
                                        <div class="tab-pane" id="tab_1_2">
                                            ...
                                            <form action="<?php echo e(route('user.update.profile.pic')); ?>" method="post" role="form" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="form-group">
