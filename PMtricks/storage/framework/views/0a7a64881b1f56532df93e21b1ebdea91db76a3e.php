                ...
                <div class="portlet light form-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green sbold uppercase">Comments | <?php echo e($page); ?></span>
                        </div>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="row" style="border-bottom: 1px solid #ccc; padding: 10px 0;">
                                        <div class="col-md-11">
                                            ...
                                            <?php if($page == 'video'): ?>
                                                <h5><i><b>Course:</b> <?php echo e(\App\Course::find(\App\Chapters::find(\App\Video::find(\App\PageComment::where('comment_id', $comment->id)->get()->first()->item_id)->chapter)->course_id)->title); ?></i></h5>
                                                <h5><i><b>Video:</b> <?php echo e(\App\Video::find(\App\PageComment::where('comment_id', $comment->id)->get()->first()->item_id)->title); ?></i></h5>                                            
                                            <?php elseif($page == 'chapter'): ?>
                                                <h5><i><b>Course:</b> <?php echo e(\App\Course::find(\App\Chapters::find(\App\PageComment::where('comment_id', $comment->id)->get()->first()->item_id)->course_id)->title); ?></i></h5>
                                                <h5><i><b>Chapter:</b> <?php echo e(\App\Chapters::find(\App\PageComment::where('comment_id', $comment->id)->get()->first()->item_id)->name); ?></i></h5>
                                            <?php elseif($page == 'exam'): ?>
                                                <h5><i><b>Exam:</b> Exam <?php echo e(\App\PageComment::where('comment_id', $comment->id)->get()->first()->item_id); ?></i></h5>
                                            <?php elseif($page == 'process_group'): ?>
                                                <h5><i><b>Process Group:</b> <?php echo e(\App\Process_group::find(\App\PageComment::where('comment_id', $comment->id)->get()->first()->item_id)->name); ?></i></h5>
                                            <?php endif; ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e(\App\Comment::whereIn('id',\App\PageComment::where('page', $page)->pluck('comment_id')->toArray())->paginate(15)->links()); ?>
