...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1318px">
        ...
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <form action="<?php echo e(route('packages.update', $package->id)); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data" style="background: white; padding: 30px 15px;">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                <input type="text" class="form-control input-sm" name="name" placeholder="Client ID" value="<?php echo e($package->name); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="price" placeholder="original price before discount" value="<?php echo e(round($package->original_price, 2)); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="extension_price" placeholder="Extension Price" value="<?php echo e(round($package->extension_price, 2)); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="expire" placeholder="Expire in NO. of days" value="<?php echo e($package->expire_in_days); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="extension_in_days" placeholder="extend package for NO. of days" value="<?php echo e($package->extension_in_days); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="max_extension" placeholder="Max Extension" value="<?php echo e($package->max_extension_in_days); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="discount" placeholder="discount" value="<?php echo e($package->discount); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <select name="course_id" id="course_id" class="form-control">
                        ...
                        <option value="<?php echo e($c->id); ?>" 
                            <?php if($package->course_id == $c->id): ?>
                                selected
                            <?php endif; ?>   ><?php echo e($c->title); ?></option>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="lang" placeholder="Language" value="<?php echo e($package->lang); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <textarea class="form-control input-sm jqte-test" name="description" id="" cols="30" rows="10"><?php echo e($package->description); ?></textarea>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <textarea class="form-control input-sm jqte-test" name="what_you_learn" id="" cols="30" rows="10"><?php echo e($package->what_you_learn); ?></textarea>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <textarea class="form-control input-sm jqte-test" name="requirement" id="" cols="30" rows="10"><?php echo e($package->requirement); ?></textarea>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <textarea class="form-control input-sm jqte-test" name="who_course_for" id="" cols="30" rows="10"><?php echo e($package->who_course_for); ?></textarea>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <textarea class="form-control input-sm jqte-test" name="enroll_msg" id="" cols="30" rows="10"><?php echo e($package->enroll_msg); ?></textarea>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <select name="certification" id="certification">
                        <option value="1" <?php if($package->certification == 1): ?> selected <?php endif; ?>>True</option>
                        <option value="0" <?php if($package->certification == 0): ?> selected <?php endif; ?>>False</option>
                    </select>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="certification_title" id="certification_title" placeholder="Certification title" value="<?php echo e($package->certification_title); ?>" >
                    <div class="form-control-focus"> </div>
                </div>
            </div>
