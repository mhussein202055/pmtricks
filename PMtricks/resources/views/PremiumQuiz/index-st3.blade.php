                    ...
                    <div class="col-md-9 form-1" id="quiz_app_container" style="border: 1px solid #eef1f5 !important;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-xs-8">
                                            <div class="mt-element-ribbon bg-grey-steel">
                                                ...
                                                <p class="ribbon-content" align="center" style="font-size: 20px">75%</p>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group" style="display:flex; justify-content: center; align-items: center;">
                                        @if($quiz)
                                            ...
                                            @else
                                                <a v-on:click="optimizeQuiz" class="btn btn-primary" id="startQuiz">Continue</a>
                                            @endif
                                        @else
                        ...
                        <div class="container-fluid primeQuizViewWM" id="quiz" style="min-height: 50px; margin:20px 0; display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="  min-height: 30px; font-size: 18px; margin-bottom: 15px;">
                                ...
                                <div class="col-md-offset-2 col-md-2" style="  min-height: 30px; text-align: right; font-size: 18px;margin-bottom: 15px;">
                            ...
                            <div class="tab-content">
                                <div id="result" class="tab-pane fade in active">
                                    ...
                                    <div class="row" style="border:1px solid dimgrey; text-align: center; padding: 10px 0; color:gray; font-weight: lighter;">
                                        <i style="margin: 0 5px;">{{Auth::user()->name}}</i> |
                                    ...
                                    <div class="row" style="border:1px solid dimgrey; text-align: left; padding: 10px 10px; margin-top: 20px; ">
                                        ...
                                        <p v-html="ScoreMsg">
                                            {{-- <b><h4>Your Overall Performance: <i > Success </i></h4></b>
                                            You have failed your exam, you must improve to get certified. --}}
                                        </p>
                                        {{--
                                                                        <div class="container">
                                                                            <div class="row">
                                                                                <div class="col-md-3" style="background-color:#e69b5a; height:30px;">#ed7813</div>
                                                                                <div class="col-md-3" style="background-color:#e7ed77; height:30px;">#dae332</div>
                                                                                <div class="col-md-3" style="background-color:#6fe8dc; height:30px;">#22e6d2</div>
                                                                                <div class="col-md-3" style="background-color:#8be368; height:30px;">#6ced39</div>
                                                                            </div>
                                                                        </div> --}}
                                        ...
                                        <div class="fluid-container" style ="margin:70px 0;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3" style=" height:25px;">
                                                    ...
                                                    <div v-if="score < 60" style="background-color:#ed7813; opacity:0.2; height:20px; widht:100%; margin-bottom:10px;">You</div>
                                                    Needs Improvement
                                                </div>
                                                <div class="col-md-3" style=" height:25px;">
                                                    <div v-if="score >= 74" style="background-color:#dae332; opacity:1; height:20px; widht:100%;margin-bottom:10px; padding-top:">
                                                        <i style="color:white;" v-if="score >= 61 && score <74">You</i>
                                                    </div>
                                                    <div v-if="score < 74" style="background-color:#dae332; opacity:0.2; height:20px; widht:100%;margin-bottom:10px;"></div>
                                                    Below Target
                                                </div>
                                                <div class="col-md-3" style=" height:25px;">

                                                    <div v-if="score >= 75" style="background-color:#22e6d2; opacity:1; height:20px; widht:100%;margin-bottom:10px;">
                                                        <i style="color:white;" v-if="score >= 75 && score <84">You</i>
                                                    </div>
                                                    <div v-if="score < 75" style="background-color:#22e6d2; opacity:0.2; height:20px; widht:100%;margin-bottom:10px;"></div>
                                                    Target
                                                </div>
                                                <div class="col-md-3" style=" height:25px;">
                                                    <div v-if="score >= 85" style="background-color:#6ced39; opacity:1; height:20px; widht:100%;margin-bottom:10px;">
                                                        <i style="color:white;" v-if="score >= 85 && score <=100">You</i>
                                                    </div>
                                                    <div v-if="score < 85" style="background-color:#6ced39; opacity:0.2; height:20px; widht:100%;margin-bottom:10px;"></div>
                                                    Above Target
                                                </div>
                                                        ...
                                                        <div class="container" id="view2{{$quiz_z->id}}" style="border:1px solid #ccc; width:80%; padding: 25px 0;box-shadow: 0px 9px 15px -4px rgba(0,0,0,0.14);display:none;">
                                                            <div class="row" >
                                                                ...
                                                                <div class="col-md-6" style="display:flex; justify-content: space-evenly; align-items:flex-start; flex-direction:column; flex-wrap: wrap;">
                                                                    ...
                                                                    <div style="margin:5px;">
                                                                        <a href="{{route('QuizHistory.show', $quiz_z->id)}}" class="btn red">Review questions </a>
                                                                    </div>
                                ...
                                @if(count($chapters_inc) > 0)
                                    <table class="table table-hover">
                                        ...
                                        @foreach($chapters_inc as $item)
                                            @if(\App\Question::where('chapter', $item->id)->get()->first())
                                                <tr>
                                                    <td>
                    ...
                    if(app.make_exam.taken == 0){
                        ...
                        if(conf){
                            ...
                            for(i in this.scoreAnalysis){
                                ...
                                }else if(process_score > 61 && process_score<=74){
                            ...
                            for(i in this.scoreAnalysisByChapter){
                                ...
                                }else if(chapter_score > 61 && chapter_score<=74){
