												...
												<div class="best-course-pic-text relative-position">
													<div class="best-course-pic relative-position">
														...
														<div class="course-details-btn">
															<a href="{{route('public.package.view', $i->package->id)}}">COURSE DETAIL <i class="fas fa-arrow-right"></i></a>
														</div>
														<div class="blakish-overlay"></div>
													</div>
													<div class="best-course-text">
														<div class="course-title mb20 headline relative-position">
															<h3><a href="{{route('public.package.view', $i->package->id)}}">{{$i->package->name}}</a></h3>
														</div>
														<div class="course-meta">
															<span class="course-category"><a href="{{route('public.package.view', $i->package->id)}}">{{\App\Course::find(Illuminate\Support\Facades\Input::get('course_id'))->title}}</a></span>
											...
											<tr>
												...
												<td>
													<div class="course-type-list">
														...
														<span>{{\App\Course::find($i->package->course_id)->title}}</span>
													
													</div>
												</td>
												<td>{{$i->package->expire_in_days}} days</td>
											</tr>
											@endforeach
									...
									<form action="#" method="get">
										<div class="filter-select mb20">
											...
											<select name="course_id">
												@foreach(\App\Course::where('private', 0)->get() as $c)
                                                <option @if(Illuminate\Support\Facades\Input::get('course_id') == $c->id) selected @endif value="{{$c->id}}">{{$c->title}}</option>
                                                @endforeach
											</select>
										</div>
							...
							<div class="side-bar-widget">
								...
								<div class="featured-course">
									<div class="best-course-pic-text relative-position">
										...
										<div class="best-course-text">
											<div class="course-title mb20 headline relative-position">
												<h3><a href="{{route('public.package.view', $best_sell[0]->package->id)}}">{{$best_sell[0]->package->name}}</a></h3>
											</div>
											<div class="course-meta">
												<span class="course-category"><a href="{{route('public.package.view', $best_sell[0]->package->id)}}">{{\App\Course::find($best_sell[0]->package->course_id)->title}}</a></span>
