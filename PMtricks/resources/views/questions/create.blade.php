                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form vueform">
                                    {!! Form::open(['action' => 'QuestionsController@create', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal']) !!}
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input has-success">
                                                <label class="col-md-2 control-label" for="form_control_1">Question</label>
                                                <div class="col-md-10">
                                                    {{Form::textarea('question', '', ['v-model'=>'title','class' => 'form-control', 'placeholder'=>'Question', 'row'=>'3','style'=>'margin: 0px 0.65625px 0px 0px; height: 200px;'])}}
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    {{Form::text('answer_a', '', ['v-model'=>'b','class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    {{Form::text('answer_b', '', ['v-model'=>'c','class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    {{Form::text('answer_c', '', ['v-model'=>'d','class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group form-md-line-input">
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                ...
                                                <div class="col-md-10">
                                                        {{ Form::textarea('feedback','',['class'=>'form-control','row'=>'3','placeholder'=>'Feedback for the Correct Answer', 'style'=>'margin: 0px 0.65625px 0px 0px; height: 200px;'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                ...
                methods:{
                    ...
                    review: function(){
                        if(
                            ...
                            $('.review-msg').hide();
                            window.open("{{url('/admin/question/review')}}/"+this.title+'/'+this.a+'/'+this.c+'/'+this.b+'/'+this.d,'_blank','resizable,height=560,width=1070'); return false;
                        }
