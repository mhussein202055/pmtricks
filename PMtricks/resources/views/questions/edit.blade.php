                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form vueform">
                                    {!! Form::open(['action' => ['QuestionsController@update', $question->id], 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal']) !!}
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input has-success">
                                                <label class="col-md-2 control-label" for="form_control_1">Question</label>
                                                <div class="col-md-10">
                                                    {{Form::textarea('question', $question->title, ['class' => 'form-control', 'placeholder'=>'Question', 'row'=>'3','style'=>'margin: 0px 0.65625px 0px 0px; height: 200px; width: 1312px;'])}}
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    {{Form::text('correct_answer', $question->correct_answer, ['class' => 'form-control', 'placeholder'=>'Correct Answer', 'id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    {{Form::text('answer_a', $question->a, ['class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    {{Form::text('answer_b', $question->b, ['class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    {{Form::text('answer_c', $question->c, ['class' => 'form-control input-sm', 'placeholder'=>'False Answer','id'=>'form_control_1'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group form-md-line-input">
                                            ...
                                            <div class="form-group form-md-line-input">
                                             ...
                                             <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select v-model="pmg" class="form-control" id="pmg" v-on:change="searchPMG"  v-model="pmg" name="pmg" @if($pmg_value == '') disabled @endif>
                                                            <option disabled value="">Choose one </option>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        @if($question->img != Null)
                                                            Old Image: 
                                                            <img width="200" src="{{asset('storage/questions/'.basename($question->img)) }}">
                                                        @endif
                                                        <div>
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                ...
                                                <div class="col-md-10">
                                                        {{ Form::textarea('feedback',$question->feedback,['class'=>'form-control','row'=>'3','placeholder'=>'Feedback for the Correct Answer', 'style'=>'margin: 0px 0.65625px 0px 0px; height: 200px; width: 1312px;'])}}
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            var app = new Vue({
                ...
                data:{
                    ...
                    chapter_data: [
                        @foreach(\App\Chapters::where('course_id', '=', $course)->get() as $ch)
                            '{{$ch->name}}',
                        @endforeach
                    ],
                    pmg: '{{$pmg_value}}',
