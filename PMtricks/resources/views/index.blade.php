      ...
      <div id="course-slide-item" class="course-slide">
        ...
        <div class="course-item-pic-text">
          <div class="course-pic relative-position mb25"> <img src="{{ url('storage/package/imgs/'.basename($i->package->img))}}" alt="">
            ...
            <div class="course-details-btn"> <a href="@if($i->package->contant_type == 'question'){{route('attach.package', $i->package->id)}}@elseif($i->package->contant_type == 'video'||$i->package->contant_type =='combined'){{ route('st4_vid', [$i->package->id, 'chapter', explode(',',\App\Packages::find($i->package->id)->chapter_included)[0] , \App\Video::where('chapter',explode(',',\App\Packages::find($i->package->id)->chapter_included)[0])->get()->first()->id]) }}@endif">COURSE DETAIL  <i class="fas fa-arrow-right"></i></a> </div>
          </div>
          <div class="course-item-text">
            ...
            <div class="course-title mt10 headline pb45 relative-position">
              <h3><a href="@if($i->package->contant_type == 'question'){{route('attach.package', $i->package->id)}}@elseif($i->package->contant_type == 'video' ||$i->package->contant_type =='combined'){{ route('st4_vid', [$i->package->id, 'chapter', explode(',',\App\Packages::find($i->package->id)->chapter_included)[0] , \App\Video::where('chapter',explode(',',\App\Packages::find($i->package->id)->chapter_included)[0])->get()->first()->id]) }}@endif">{{$i->package->name}}.</a> 
                @if($i->users_no >= 400)
            ...
            <div class="course-viewer ul-li">
              <ul>
                ...
                <li><a href=""><i class="fas fa-comment-dots"></i> {{count(\App\Rating::where('package_id', $i->package->id)->get())}}</a></li>
...
<!-- End why choose section
    ...
    <section id="course-category" class="course-category-section">
			<div class="container">
                ...
                <a href="{{route('package.by.course')}}?course_id=2">
                  <img src="{{asset('indexassets/img/course/PMP.png')}}" alt="PMP" />
  <!--									<i class="text-gradiant flaticon-technology"></i>-->
                ...
                <a href="{{route('package.by.course')}}?course_id=6">
								<img src="{{asset('indexassets/img/course/Sceau_certification_v3-07.png')}}" alt="PMP" />
<!--									<i class="text-gradiant flaticon-technology"></i>-->
                </a>
								</div>
								<div class="category-title">
                  ...
                  <img src="{{asset('indexassets/img/course/Sceau_certification_v3-08.png')}}" alt="SP" />
                  </a>
								</div>
								<div class="category-title">
...
<section id="about-us" class="faq-section faq-secound-home-version backgroud-style">
  <div class="container" style="color: white !important;">
    <div class="row">
{{--      <div class="col-md-5">--}}
{{--        <div class=" backgroud-style relative-position">--}}
{{--			<div class="bg-mockup" style="display: inline ; position: inherit;"> --}}
{{--				<img src="indexassets/img/about/abt.jpg" alt=""> </div>--}}
{{--        --}}
{{--        </div>--}}
{{--        --}}
{{--      </div>--}}
		...
		<section id="faq" class="faq-section faq-secound-home-version backgroud-style">
			<div class="container">
				...
				<div class="faq-tab mb45">
                  ...
                  @foreach(\App\FAQ::orderBy('created_at', 'desc')->take(4)->get() as $f)
									<div class="panel">
										<div class="panel-title" id="headingTwo">
											<h3 class="mb-0">
												<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse{{$f->id}}" aria-expanded="false" aria-controls="collapseTwo">
													{{$f->title}}
												</button>
											</h3>
										</div>
										<div id="collapse{{$f->id}}" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
				...
				<div class="about-btn text-center">
					<div class="genius-btn gradient-bg text-center text-uppercase ul-li-block bold-font">
						<a href="{{route('public.faq')}}">More <i class="fas fa-caret-right"></i></a>
					</div>
				</div>
			</div>
		</section>
...
<section id="testimonial_2" class="testimonial_2_section">
			<div class="container">
				...
				<div id="testimonial-slide-item" class="testimonial-slide-area">
					    @foreach(\App\Feedback::orderBy('created_at', 'desc')->where('disable', 0)->get() as $f)
						<div class="student-qoute">
						    <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
                            <img style="overflow:none; width:90px; height: 90px; border-radius:50%; display: block; margin-left: 50%;   " src="@if(\App\UserDetail::where('user_id', $f->user_id)->get()->first()) {{ url('storage/profile_picture/'.basename(\App\UserDetail::where('user_id', $f->user_id)->get()->first()->profile_pic))}} @else {{asset('indexassets/img/blog/default.png')}} @endif" alt="" class="img-fluid center mr-3">
						</div>
                            <p>{{$f->title}}</p>
							<p style="color: #00000" > “<b>{{$f->feedback}}</b>”</p>
							<div class="student-name-designation">
								<span class="st-name bold-font" style="font-size:16px">{{\App\User::find($f->user_id)->name}} </span>
@if(\App\UserDetail::where('user_id', $f->user_id)->get()->first())
								<span class="st-designation">{{\App\UserDetail::where('user_id', $f->user_id)->get()->first()->occupation}}</span>
@else
<span class="st-designation"></span>
@endif
                                <div class="comment-ratting ul-li">
                                  <ul style="color:orange;">
                                    <li><i style="@if($f->rate < 1)color:black !important;@endif" class="fas fa-star"></i></li>
                                    <li><i style="@if($f->rate < 2)color:black !important;@endif" class="fas fa-star"></i></li>
                                    <li><i style="@if($f->rate < 3)color:black !important;@endif" class="fas fa-star"></i></li>
                                    <li><i style="@if($f->rate < 4)color:black !important;@endif" class="fas fa-star"></i></li>
                                    <li><i style="@if($f->rate < 5)color:black !important;@endif" class="fas fa-star"></i></li>
                                  </ul>
                                </div>
							</div>
						</div>
      ...
      <div class="row">
        ...
        <div class="col-md-6" id="contact_us_form">
          <div class="contact_secound_form" >
            ...
            @endif
            <form class="contact_form" action="{{route('send.mail.customer')}}" method="POST" >
              @csrf
              <div class="contact-info">
...
<script>
  @if(count($errors) && \Session('process') == 'register')
  $("#myModal1").modal('show');
  @endif

  @if(count($errors) && \Session('process') == 'login')
  $("#myModal").modal('show');
  @endif
</script>
</body>
