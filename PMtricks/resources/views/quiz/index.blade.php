        ...
        <div class="container-fluid" id="app-1">
            <div class="row">
                <div class="col-md-7 form-1" >
                    ...
                    {{-- <div class="container-fluid primeQuizViewWM" id="quiz" style="">
                        ...
                        <div class="row st-row">
                            ...
                            <div class="col-md-3 justify-content-center align-self-center"> 
                                <a class="btn btn-info" data-toggle="modal" data-target="#flagedQuestion">Mark</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title">Mark Questions: </h4>
                        ...
                        <div class="row contral-question" style="display:flex;flex-direction: row;flex-wrap: wrap;" >
                            <div class="margin-0-3-3-0">
                            ...
                            <div class="margin-0-3-3-0">
                                <button type="button" style="display:none;" id="feedback_btn" class="btn btn-warning" data-toggle="modal" data-target="#myModal2">
                                    Feedback
                                </button>
                            </div>
                        ...
                        <div class="modal" id="myModal2">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <!-- Modal body -->
                                        <div class="modal-body">
                                            <strong>Correct answer </strong>: @{{current_question_answer}}
                                            
                                            <p style="color: black; font-weight:bold;">@{{feedback}}</p>
