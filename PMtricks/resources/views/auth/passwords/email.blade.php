...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="forget_form" action="{{ route('password.email') }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" value="{{ old('email') }}" required /> </div>
