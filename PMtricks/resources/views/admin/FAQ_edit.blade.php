            ...
            <div class="col-md-12">
                ...
                <div class="portlet light form-fit bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        <form class="form-horizontal form-bordered" method="POST" action="{{route('faq.update', $q->id)}}">
                            @csrf
                            <div class="form-body">
                                <div class="form-group last">
                                    <label class="control-label col-md-2">Title </label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" value="{{$q->title}}" name="title" id="maxlength_thresholdconfig">
                                    </div>
                                </div>
                                <div class="form-group last">
                                    <label class="control-label col-md-2">FAQ </label>
                                    <div class="col-md-10">
                                        <textarea name="contant" class="jqte-test">{{$q->contant}}</textarea>
                                    </div>
                                </div>
                            </div>
