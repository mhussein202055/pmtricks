            ...
            <div class="col-md-12">
                ...
                <div class="portlet light form-fit bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        <form class="form-horizontal form-bordered" enctype="multipart/form-data" method="POST" action="{{route('flashCard.add')}}">
                            @csrf
                            <div class="form-body">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light form-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-settings font-green"></i>
                            <span class="caption-subject font-green sbold uppercase">Flash Card All</span>
                        </div>
