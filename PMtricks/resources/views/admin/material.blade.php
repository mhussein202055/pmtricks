            ...
            <div class="col-md-12">
                ...
                <div class="portlet light form-fit bordered">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{route('material.add')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                ...
                <div class="portlet light form-fit bordered">
                    ...
                    <div class="portlet-body form">
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                @foreach(\App\Material::orderBy('created_at', 'desc')->get() as $q)
                                <tr>
                                    <td></td>
                                    <td>{{$q->title}}</td>
                                    <td>{{$q->created_at}}</td>
