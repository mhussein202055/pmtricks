            ...
            <div class="col-md-12">
                <div class="table-responsive ">          
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            @foreach(\App\DisabledUser::orderBy('created_at', 'desc')->paginate(25) as $user)
                                <tr>
                                    <td>{{ $user->id }}</td>
                                    <td>{{ $user->name }}</td>
                                    <td>{{ $user->email }}</td>
                                    ...
                                    <td>
                                        ...
                                        @if(\App\Payments::where('user_id','=', $user->user_id)->get()->first())
                ...
                <center>
                {{ \App\DisabledUser::orderBy('created_at', 'desc')->paginate(25)->links() }}
                </center>
            </div>
        </div>
        <!-- END PAGE TITLE-->
