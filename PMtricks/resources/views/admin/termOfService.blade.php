    ...
    <div class="page-content" style="min-height:1318px">
        ...
        <div class="row" style="background-color: white; padding: 0 0;">
            <div class="col-md-12">
                ...
                <form action="{{route('admin.terms.store')}}" method="POST" class="form-horizontal" style="background: white; padding: 30px 15px;">
                    @csrf
                    
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="form_control_1" ></label>
                        <div class="col-md-8">
                            <textarea name="terms" class="jqte-test">{{ \App\PaypalConfig::all()->first()->term_of_service }}</textarea>
