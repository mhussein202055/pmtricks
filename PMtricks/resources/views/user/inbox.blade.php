								...
								<div class="kt-grid__item kt-app__toggle kt-app__aside kt-app__aside--lg kt-app__aside--fit" id="kt_chat_aside">
									...
									<div class="kt-portlet kt-portlet--last">
										<div class="kt-portlet__body">
                                            <div class="row">
                                                <a href="{{route('user.dashboard')}}" class="btn btn-default" style="text-align:center; width:100%;" >DashBoard</a>
                                            </div>
                                                            ...
                                                            <div class="kt-widget__item">
                                                                ...
                                                                <div class="kt-widget__info">
                                                                    <div class="kt-widget__section">
                                                                        <a href="{{route('user.inboxv2')}}?user_id={{$user->id}}" class="kt-widget__username">
                                                                            {{$user->name}}
                                                                        </a>
														...
														@if(count($messages) == 0)
															...
															<div class="kt-widget__item">
																<span class="kt-userpic kt-userpic--circle">
																	...
																	<a href="{{route('user.inboxv2')}}?user_id={{$user->id}}">
																		<img src="{{asset('storage/icons/user/'.rand(1,3).'.png')}}" alt="image">
																	</a>
																</span>
																<div class="kt-widget__info">
																	<div class="kt-widget__section">
																...
																<div class="kt-widget__action">
																	<span class="kt-widget__date">{{\Carbon\Carbon::now()->diffForHumans()}}</span>
																</div>
									...
									<div class="kt-chat">
										<div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
											...
											<div class="kt-portlet__foot" id="app-2">
												<form  method="POST" action="{{route('user.inboxv2.send')}}" enctype="multipart/form-data">
                                                    @csrf
